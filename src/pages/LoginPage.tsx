        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-3">
              ...
              <div>
                <p className="text-sm text-gray-500 mb-1">Regular user:</p>
                <p className="text-sm text-gray-800">Email: user@example.com</p>
                <p className="text-sm text-gray-800">Password: user123</p>
              </div>
            </div>
          </div>
        </div>
